...
export const SLIDES: Slide[] = [
  {
    ...
    illustration: {
      type: 'mockup',
      description: "Google Search Mockup: 'Best hair salon near me' showing competitors with 5 stars vs an unclaimed, empty profile for the client.",
  ...
  },
  {
    ...
    illustration: {
      type: 'diagram',
      description: "Funnel diagram showing searches leading to clicks, then customers, with a 'leaking' funnel representing missed opportunities.",
  ...
  },
  {
    ...
    illustration: {
      ...
      imageUrl: "https://picsum.photos/seed/problems/800/600"
    },
    accentColor: "text-[#FF3131]"
  },
  {
  ...
  },
  {
    ...
    illustration: {
      type: 'reviews',
      description: "Comparison of a low-ranked business with 1 star vs a high-ranked business with 5 stars and professional photos.",
      beforeAfter: {
        before: "Low Rank (1.2 ⭐)",
        after: "High Rank (4.9 ⭐)"
      }
  ...
  },
  {
    ...
    illustration: {
      type: 'roi',
      description: "A dynamic graphic showing a rising ROI curve, symbolizing business growth and increased revenue with Elevate.",
      imageUrl: "https://picsum.photos/seed/roi-growth/800/600"
    },
    accentColor: "text-[#B2FF05]"
  }
];
